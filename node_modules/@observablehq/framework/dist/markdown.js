...
function makeFenceRenderer(root, baseRenderer, sourcePath) {
...
function makePlaceholderRenderer(root, sourcePath) {
...
function parseMarkdown(input, { root, path, markdownIt = (md) => md, style: configStyle }) {
  ...
  const code = [];
  const context = { code, startLine: 0, currentLine: 0 };
...
function getStylesheet(path, data, style = null) {
  try {
