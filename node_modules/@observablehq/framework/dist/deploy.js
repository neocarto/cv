...
async function deploy({ config, message, deployPollInterval = DEPLOY_POLL_INTERVAL_MS }, effects = defaultEffects) {
...
class DeployBuildEffects {
  constructor(apiClient, deployId, effects) {
...
async function promptDeployTarget(effects, api, config, currentUser) {
  ...
  if (title === void 0) {
    ...
    title = titleChoice;
    clack2.log.info("You should add this title to your observablehq.config.ts file.");
  }
